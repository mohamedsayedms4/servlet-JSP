...
<body>
<form method="get" action="userdetails.jsp" id="login-form" class="login-form" autocomplete="off" role="main">
  <h1 class="a11y-hidden">Login Form</h1>
  
  <!-- Email input -->
  <div>
    <label class="label-email">
      <input type="text" class="text" name="fullName" placeholder="fullName" tabindex="1" required />
  ...
  <div>
    <label class="label-age">
      <input type="text" class="text" name="age" placeholder="Age" tabindex="3" required />
  ...
  <div>
  <span class="required">Address (Radio):</span><br/>
  <input type="radio" id="cairo" name="radioCity" value="cairo" required>
  <label for="cairo">Cairo</label><br/>

  <input type="radio" id="alex" name="radioCity" value="alex">
  <label for="alex">Alex</label><br/>

  <input type="radio" id="menofia" name="radioCity" value="menofia">
  ...
  <!-- Address Select menu -->
  <div>
    <label class="label-select-city">
      <span class="required">Address (Select):</span>
